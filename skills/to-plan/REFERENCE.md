...
- Judge readiness on three signals: correct problem summary, correct skill list, and at least one concrete edge case. A vague summary is a fail; correct scope and re-spawn rather than coaching across rounds.
